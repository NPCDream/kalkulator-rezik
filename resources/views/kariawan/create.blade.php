...
<div class="card-body">
<form action="{{ route('kariawan.store') }}" method="POST" enctype="multipart/form-data">
@csrf

<div class="form-group">
<label class="font-weigh-bold">namakariawan</label>
<input type="text" class="form-control @error('namakariawan') is-invalid @enderror" name="namakariawan" value="{{old('namakariawan') }}" placeholder="Masukkan Berat Pakaian">
