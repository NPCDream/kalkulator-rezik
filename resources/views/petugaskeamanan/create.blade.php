...
<div class="card-body">
<form action="{{ route('petugaskeamanan.store') }}" method="POST" enctype="multipart/form-data">
@csrf

<div class="form-group">
<label class="font-weigh-bold">namapetugaskeamanan</label>
<input type="text" class="form-control @error('namapetugaskeamanan') is-invalid @enderror" name="namapetugaskeamanan" value="{{old('namapetugaskeamanan') }}" placeholder="Masukkan Berat Pakaian">
